...
<html lang="{{ app()->getLocale() }}">
    ...
    <body class="bg-gray-900 text-gray-400">
        ...
        <footer class="container pb-32 pt-8 md:py-8">
            <p class="text-center">
                Made with <x:zondicon-heart class="fill-current h-3 inline" /> by <a href="https://twitter.com/benjamincrozat" target="_blank" class="link hover:text-white">Benjamin Crozat</a>.
            </p>

            <ul class="flex items-center justify-center mt-4">
                <li>
                    <a href="https://dribbble.com/benjamincrozat" class="hover:text-white">
                ...
                <li class="ml-2">
                    <a href="https://github.com/benjamincrozat" class="hover:text-white">
                ...
                <li class="ml-2">
                    <a href="https://www.instagram.com/benjamincrozat/" class="hover:text-white">
                ...
                <li class="ml-2">
                    <a href="https://linkedin.com/in/benjamincrozat" class="hover:text-white">
                ...
                <li class="ml-2">
                    <a href="https://medium.com/@benjamincrozat" class="hover:text-white">
                ...
                <li class="ml-2">
                    <a href="https://twitter.com/benjamincrozat" class="hover:text-white">
