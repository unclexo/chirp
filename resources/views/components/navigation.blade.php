<nav>
    ...
    <button
        type="button"
        id="nav-btn"
        class="-tx-50 bg-blurred bg-gray-600 bg-opacity-75 bottom-0 fixed md:hidden h-16 left-50 mb-8 rounded-full text-center text-gray-900 w-16 z-20"
    >
    ...
    <ul
        id="nav"
        class="-tx-50 md:t-none bg-gray-800 md:bg-transparent bottom-0 fixed md:static hidden md:block mb-32 md:mb-0 md:mt-8 p-4 md:p-0 w-full md:w-auto z-20"
        style="left: 50%"
    >
        <li>
    ...
    <div id="nav-overlay" class="bg-black bg-opacity-50 bottom-0 fixed hidden left-0 right-0 top-0 z-10" style="-webkit-backdrop-filter: blur(10px); backdrop-filter: blur(10px)"></div>
