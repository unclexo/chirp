<x-layout>
    ...
    <form method="POST" action="@route('user.delete')" class="bg-gray-700 bg-opacity-50 mt-8 px-4 py-8 lg:p-8 rounded shadow">
        ...
        <h4 class="font-semibold leading-none">Remove your account</h4>

        <div class="sm:flex sm:items-center mt-4">
            <p>
                <strong class="font-semibold">All your data will definitely be lost</strong>. You will still be able to come back to @config('app.name') whenever you want.
            </p>
