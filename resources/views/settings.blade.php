<x-layout>
    ...
    <form method="POST" action="@route('user.delete')" class="sm:flex sm:items-center mt-4">
        ...
        <button type="button" class="bg-red-500 hover:bg-red-400 font-semibold inline-block sm:ml-8 mt-4 sm:mt-0 mx-auto px-4 py-2 rounded text-red-100 table sm:inline-block hover:text-white">Supprimer</button>
    </form>
</x-layout>
